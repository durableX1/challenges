...
animate_text $'\nWelcome Neo, It'\''s Time To Fight!' 0.06
...
animate_text $'If You Find The pass or flag you Go To The Directory *check_it* paste and take your need!' 0.04
...
case $choice in
    1)
        ...
        animate_text "We Wish You Only Good Luck Hacker!" 0.05
        ;;
    2)
        echo "[-] Exiting..."
        exit 1 
