        ...
        if (access(filepath, F_OK) == 0) {
            ...
            if (file != NULL) {
                ...
                if (strcmp(content, FILE_CONTENT) == 0) {
                    ...
                    if (access(FOLDER_TO_DELETE, F_OK) == 0) {
                        ...
                        if (editFile != NULL) {
                            ...
                            if (strcmp(editContent, FILE_EDIT_CONTENT) == 0) {
                                ...
                                printf("You need to edit the file with the correct content: *We Are A White Hat Hackers And We Prevent Attacks* %s\n", FILE_EDIT_PATH);
                            }
                        } else {
                    ...
                    printf("You need to write the expected content into the file: *So many things I don't know about Pokemons* %s\n", FILE_TO_CHECK);
                }
            } else {
